...
loadstring(game:HttpGet("https://github.com/DizzyUSER69/novaproject/releases/latest/download/Nova.luau"))()
```
...
[![Nova Remote Spy Demo](http://img.youtube.com/vi/Ellj_P6-yVI/0.jpg)](http://www.youtube.com/watch?v=Ellj_P6-yVI)
